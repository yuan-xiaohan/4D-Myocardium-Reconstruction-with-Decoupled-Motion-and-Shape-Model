...
def get_instance_filenames(data_source, split, normalized=False):
    npzfiles = []
    normalizationfiles = []
        ...
        for class_name in split[dataset]:
            for instance_name in split[dataset][class_name]:
                ...
                if normalized:
                    ...
                    data_source, dataset, "NormalizationParameters", class_name, instance_name + ".npz"
                )
...
class SDFSamples(torch.utils.data.Dataset):
    def __init__(
        ...
        self.npyfiles = get_instance_filenames(data_source, split)[0]
